...
folder_path = 'C:\\work\\JTCMM\\test\\지역아동센터\\'+ today.strftime('%Y') + '년\\' + amonth_ago.strftime('%#m월')
    ...
    if '지역아동' in cms_xls:
        ...
        if ('2022' in cms_xls) or ('2023' in cms_xls):
            ...
            if (str(today.year) + today.strftime('%m')) in cms_xls or (str(today.year) + amonth_ago.strftime('%m') in cms_xls):
                ...
                # xlsx_to_convert = cms_check(fail_xlsx_list, cms_xlsx_path, payment_date)
                # 월별내역에 추가하는 함수
...
if __name__ == "__main__":
    ...
    print(start_time)
    main(r'C:\Users\vivans\Desktop\stu_test\20230701_20230701_지역아동센터.xls')
