...
#             shutil.move(folder_xlsx_path, f'./test/백업/{today.month}{today.day}/')
#
...
def main(cms_xls):
    ...
    cms_check(fail_xlsx_list, cms_xlsx_path, jtt_xlsx_list, payment_date)
    # xlsx2xls(xlsx_to_convert)

if __name__ == "__main__":
    start_time = datetime.now()
    print(start_time)
    main(r'C:\work\JTCMM\test\cms\20221026_20221026_지역아동센터.xls')
