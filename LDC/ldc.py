...
def main(comment,subject):
    ...
    for i in range(2,ws_or.max_row+1):
        ...
        if q is None:
            ...
            q = 'Manufacturer: ' + str(q)+ ',@'
        if r is None:
            r = 'Model Number: ,@'
        else:
            r = 'Model Number: ' + str(r) + ',@'
        if s is None:
            s = 'Rating: ,@'
        else:
            s = 'Rating: ' + str(s) + ',@'
        if t is None:
            ...
            t = 'Serial Number: ' + str(t) + ',@'
        if u is None:
            u = 'Drawing Number: ,@'
        else:
            u = 'Drawing Number: ' + str(u) + ',@'
        if v is None:
            v = 'Department Type: ,@'
        else:
            v = 'Department Type: ' + v + ',@'
