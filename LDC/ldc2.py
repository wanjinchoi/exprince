    ...
    for i in range(2,ws_or.i+1):
        ...
        if i==2 and eq_section2 == '':
            ...
            if len(eq_section)> 240:
                ...
                ws_fm["B" + str(d_i + 1)].value = '-'
                ws_fm["D" + str(d_i + 1)].value = eq_section
                wb_fm.save(result_path)

            d_i = max((a.row for a in ws_fm['D'] if a.value is not None))
            ws_fm["A" + str(d_i + 1)].value = ws_or['A' + str(i)].value
            ws_fm["C" + str(d_i + 1)].value = ws_or["C" + str(i)].value
                ...
                if len(b) > 250:
                    ...
                    for dz in za:
                        ...
                        if x == 1:
                            ...
                            ws_fm["E" + str(d_i + 1)].value = qty
                            #Unit
                            ws_fm["F" + str(d_i + 1)].value = ws_or["G" + str(i)].value
                            ws_fm["D" + str(d_i + 1)].value = dz
                            wb_fm.save(result_path)
                            x += 1
                        else:
            ...
            if eq_section == eq_section2:
                ...
                if eq_section2 == '':
                    ...
                    if ws_fm["D" + str(d_i)].value == eq_section:
                        pass
                    else:
                        if len(eq_section) > 240:
                            eq_len = len(eq_section)
                    ...
                    if eq_section2 == '':
                        ...
                        ws_fm["B" + str(d_i+1)].value = '-'
                        ws_fm["D" + str(d_i+1)].value = eq_section2
                    wb_fm.save(result_path)
    wb_fm.close()
    wb_or.close()
if __name__ == "__main__":
    main('nothing','Aux.Engine No.02')
