...
# nulack_filepath = 'C:\\ArgosRPA\\vgroup\\nulack\\'+today.strftime('%m%d')+'nulack_Name.xlsx'
# nulack_path = 'C:\\ArgosRPA\\vgroup\\nulack\\'
# form_path = 'C:\\ArgosRPA\\vgroup\\form\\nulack.xlsx'
    ...
    if paper_num =='' or paper_num is None:
        ...
        if paper_num in complete_list:
            ...
            if today.strftime('%m%d')+'nulack_Name.xlsx' in nulack_exist:
                ...
                if ws['A'+str(i)].value == paper_num:
                    pass
                else:
                    ws['A' + str(i + 1)].value = paper_num
