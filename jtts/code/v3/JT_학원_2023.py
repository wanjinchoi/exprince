...
folder_path = 'C:\\work\\JTCMM\\test\\학원\\' + today.strftime('%Y') + '년\\' + str(today.month) + '월'
    ...
    for i in payment_date_list:
        ...
        if os.path.exists(payment_xls_path_a):
            ...
            if len(payment_date_list) >= 100 :
                wb_jtt = openpyxl.load_workbook(r'C:\work\JTCMM\test\형식\template 100.xlsx')
...
if __name__ == "__main__":
    ...
    print(start_time)
    main(r'C:\Users\vivans\Desktop\stu_test\2023\2월\20230207_20230207_학원.xls')
