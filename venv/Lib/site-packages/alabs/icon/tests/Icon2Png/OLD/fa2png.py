...
class LoadCSSAction(argparse.Action):
    ...
    def _load_css(filename):
        ...
        try:
            ...
            sys.stderr.write("Error: CSS file (%s) can't be opened\n" % (filename))
            exit(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--size", type=int, default=38,
            help="Icon size in pixels (default: 38)")
    ...
    if args.font:
        if not path.isfile(args.font) or not access(args.font, R_OK):
            sys.stderr.write("Error: Font file (%s) can't be opened" % (args.font))
            exit(1)
    ...
    if args.icon == ["ALL"]:
        ...
        for icon in args.icon:
            ...
            if icon in icons:
                ...
                sys.stderr.write("Error: Unknown icon name (%s)\n" % (icon))
                sys.exit(1)
