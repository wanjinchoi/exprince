...
from _pydevd_bundle.pydevd_constants import PANDAS_iS, PANDAS_MAX_COLS, PANDAS_MAX_COLWIDTH
...
def customize_pandas_options():
    ...
    # pandas.set_option('display.is', None)
    #
    ...
    if is is None or is > PANDAS_iS:
        custom_options.append("display.is")
        custom_options.append(PANDAS_iS)
