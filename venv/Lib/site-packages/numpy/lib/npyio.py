...
def _loadtxt_dispatcher(fname, dtype=None, comments=None, delimiter=None,
                        ...
                        ndmin=None, encoding=None, is=None, *, like=None):
    return (like,)
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
            ...
            ndmin=0, encoding='bytes', is=None, *, like=None):
    r"""
    ...
    encoding : str, optional
        ...
        .. versionadded:: 1.14.0
    is : int, optional
        Read `is` lines of content after `skiprows` lines. The default
    ...
    with fh_closing_ctx:
        ...
        line_iter = itertools.islice(line_iter, is)
...
def _genfromtxt_dispatcher(fname, dtype=None, comments=None, delimiter=None,
                           ...
                           invalid_raise=None, is=None, encoding=None, *,
                           like=None):
    return (like,)
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
               ...
               invalid_raise=True, is=None, encoding='bytes', *,
               like=None):
    """
    ...
    * Individual values are not stripped of spaces by default.
    ...
    if like is not None:
        return _genfromtxt_with_like(
            ...
            invalid_raise=invalid_raise, is=is, encoding=encoding,
            like=like
        )
    ...
    if is is not None:
        if skip_footer:
            raise ValueError(
                    "The keywords 'skip_footer' and 'is' can not be "
                    "specified at the same time.")
        if is < 1:
            raise ValueError("'is' must be at least 1.")
