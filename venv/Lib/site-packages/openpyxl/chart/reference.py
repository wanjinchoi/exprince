...
class Reference(Strict):
    ...
    i = MinMax(min=1, max=1000000, expected_type=int)
    ...
    def __init__(self,
        ...
        if range_string is not None:
            ...
            min_col, min_row, max_col, i = boundaries
    ...
    def __str__(self):
        ...
        return fmt.format(self.sheetname,
                          ...
                          get_column_letter(self.max_col), self.i
                          )
    ...
    def __len__(self):
        if self.min_row == self.i:
            return 1 + self.max_col - self.min_col
        return 1 + self.i - self.min_row
    ...
    def cols(self):
        ...
        for col in range(self.min_col, self.max_col+1):
            yield Reference(self.worksheet, col, self.min_row, col, self.i)
