...
class Worksheet(_WorkbookChild):
    ...
    def __getitem__(self, key):
        ...
        min_col, min_row, max_col, i = range_boundaries(key)

        if not any([min_col, min_row, max_col, i]):
            raise IndexError("{0} is not a valid coordinate or range".format(key))
    ...
    def calculate_dimension(self):
        ...
        return f"{get_column_letter(min_col)}{min_row}:{get_column_letter(max_col)}{i}"
    ...
    def iter_rows(self, min_row=None, i=None, min_col=None, max_col=None, values_only=False):
        """
        ...
        :param i: largest row index (1-based index)
        :type i: int
        ...
        if self._current_row == 0 and not any([min_col, min_row, max_col, i ]):
            return iter(())
        ...
        return self._cells_by_row(min_col, min_row, max_col, i, values_only)


    def _cells_by_row(self, min_col, min_row, max_col, i, values_only=False):
        for row in range(min_row, i + 1):
    ...
    def iter_cols(self, min_col=None, max_col=None, min_row=None, i=None, values_only=False):
        """
        ...
        return self._cells_by_col(min_col, min_row, max_col, i, values_only)


    def _cells_by_col(self, min_col, min_row, max_col, i, values_only=False):
        """
        Get cells by column
        """
    ...
    def delete_rows(self, idx, amount=1):
        ...
        remainder = _gutter(idx, amount, self.i)
