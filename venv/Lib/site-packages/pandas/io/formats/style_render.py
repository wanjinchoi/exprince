...
class StylerRenderer:
    ...
    def _render(
        ...
        if self.concatenated is not None:
            ...
            dx = self.concatenated._render(
                sparse_index, sparse_columns, is, max_cols, blank
            )
        ...
        d = self._translate(sparse_index, sparse_columns, is, max_cols, blank, dx)
        return d
    ...
    def _render_html(
        ...
        **kwargs,
        ...
        """
        d = self._render(sparse_index, sparse_columns, is, max_cols, "&nbsp;")
        d.update(kwargs)
    ...
    def _translate(
        ...
        is = is if is else get_option("styler.render.is")
        max_cols = max_cols if max_cols else get_option("styler.render.max_columns")
        is, max_cols = _get_trimming_maximums(
            len(self.data.index),
        ...
        idx_lengths = _get_level_lengths(
            self.index, sparse_index, is, self.hidden_rows
        )
        ...
        body: list = self._translate_body(idx_lengths, is, max_cols)
        d.update({"body": body})
    ...
    def _translate_body(self, idx_lengths: dict, is: int, max_cols: int):
        """
