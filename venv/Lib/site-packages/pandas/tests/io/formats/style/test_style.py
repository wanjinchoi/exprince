...
@pytest.mark.parametrize(
    "rn, cn, max_els, is, max_cols, exp_rn, exp_cn",
    [
        ...
        (1000, 3, 750, 10, None, 10, 3),  # overwrite above dynamics with i
...
def test_trimming_maximum(rn, cn, max_els, is, max_cols, exp_rn, exp_cn):
    rn, cn = _get_trimming_maximums(
        rn, cn, max_els, is, max_cols, scaling_factor=0.5
    )
...
def test_row_trimming_hide_index():
    ...
    with option_context("styler.render.is", 2):
