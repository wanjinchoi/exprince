...
def write_dataset(data, base_dir, *, basename_template=None, format=None,
                  ...
                  is_per_file=None, min_rows_per_group=None,
                  is_per_group=None, file_visitor=None,
...
Table/RecordBatch, or iterable of RecordBatch
    ...
    is_per_group : int, default 1024 * 1024
...
'delete_matching'
    ...
    if is_per_file is None:
        is_per_file = 0

    if is_per_group is None:
        is_per_group = 1 << 20
    ...
    _filesystemdataset_write(
        ...
        max_open_files, is_per_file,
        min_rows_per_group, is_per_group, create_dir
    )
