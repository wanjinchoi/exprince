...
import re
from .ExcelMagic import i, MAX_COL
...
def rowcol_to_cell(row, col, row_abs=False, col_abs=False):
    ...
    """
    assert 0 <= row < i # i counts from 1
...
def cell_to_packed_rowcol(cell):
    ...
    if row >= i: # this for BIFF8. for BIFF7 available 2^14
        raise Exception("Row %s greater than %d in formula" % (cell, i))
