...
#     - 매니저 차단 이미지 수집 로직 추가
#  * [2024/03/04]
#     - 삭제된 게시글 처리 로직 중 driver.close() 이후 메인 윈도우 찾아줘야해서 next_page에 추가
#  * [2024/02/08]
#     - 게시글 등록 시간 수집 로직 수정(게시글 목록에서 수집)
#     - 삭제된 게시글 처리 로직 수정
#  * [2024/01/24]
        ...
        try:
            ...
            for i, ae2 in enumerate(ae_list):
                ...
                try:
                    ...
                    # 작성일시
                    e = ae2.find_element_by_xpath('./p[2]/span[@class="date_time"]')
