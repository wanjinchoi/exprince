...
class DogdripSearch(PySelenium):
        ...
        try:
            ...
            while True:
                for i, cmt_e in enumerate(comments):
                    ...
                    # 댓글 작성 시간
                    create_cmt = cmt_e.find_element_by_xpath('.//div[@class="ed flex flex-right"]//span')
                    when_cmt = create_cmt.text.strip()
                    ddd, hhh, mmm = 0, 0, 0
                    # 38분 전
    ...
    def get_article(self, msg, ndx):
        try:
            ...
            # 2) 작성자 //*[@id="main"]/div/div[2]/div/div[3]/div[1]/div[1]/div[1]/div[1]/span[1]/span/span
