        ...
        try:
            ...
            for i in range(len(bil)):
                ...
                try:
                    ...
                    # 게시글 id
                    article_id = bi.find_element_by_xpath('./td[@data-table="number"]')
                    msg['article_id'] = article_id.text

                    # 작성자
                    try:
                        author = bi.find_element_by_xpath('./td[@data-table="write"][2]')
                    except:
                        msg['author'] = ''
                    else:
