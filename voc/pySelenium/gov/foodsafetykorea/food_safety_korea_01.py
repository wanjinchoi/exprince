"""
====================================
 :mod:`gov/ food_safety_korea_01` : 정책 소식
====================================
...
################################################################################
class FoodSafetyKorea_01(PySelenium):
    # ==========================================================================
    def __init__(self, config_f):
        ...
        if not os.path.exists(log_d):
            os.makedirs(log_d)
        logger = get_logger(self.get_safe_path(log_d, 'FoodSafetyKorea_01.log'),
        ...
        self.logger.info(f'Starting FoodSafetyKorea_01 Crawaling... with '
                         f'config:\n{out_config}')
        ...
        try:
            ...
            for i, ea in enumerate(es):
                ...
                try:
                    ...
                    # 2) 게시글 id : article_id
                    e_url = ea.find_element_by_xpath('./td[2]/span[2]/a')
                    a_url = e_url.get_attribute('href')
                    v = a_url.partition("('")[2].partition("'")[0]
                    msg['article_id'] = v
                    # 3) 제목: title
                    e_t = ea.find_element_by_xpath('./td[2]/span[2]/a')
...
################################################################################
def do_start(**kwargs):
    with FoodSafetyKorea_01(kwargs['config_f']) as ws:
        ws.start()
        return 0
...
if __name__ == '__main__':
    _config_f = 'food_safety_korea_01.yaml'
