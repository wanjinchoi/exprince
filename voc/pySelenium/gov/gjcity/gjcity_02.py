...
class Gjcity02(PySelenium):
    ...
    def __init__(self, config_f):
        ...
        if not os.path.exists(log_d):
            os.makedirs(log_d)
        logger = get_logger(self.get_safe_path(log_d, 'Gjcity02.log'),
        ...
        self.logger.info(f'Starting Gjcity02 Crawaling... with '
                         f'config:\n{out_config}')
        ...
        try:
            ...
            for i, ea in enumerate(es):
                ...
                try:
                    ...
                    msg['article_id'] = v
                    # 3) 작성자
                    e = ea.find_element_by_xpath('./td[@class="list_write"]')
...
################################################################################
def do_start(**kwargs):
    with Gjcity02(kwargs['config_f']) as ws:
        ws.start()
        return 0
