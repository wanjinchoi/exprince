...
class Gnews02(PySelenium):
    ...
    def __init__(self, config_f):
        ...
        if not os.path.exists(log_d):
            os.makedirs(log_d)
        logger = get_logger(self.get_safe_path(log_d, 'Gnews02.log'),
        ...
        self.logger.info(f'Starting Gnews02 Crawaling... with '
                         f'config:\n{out_config}')
    ...
    def get_article(self, msg, ndx):
        try:
            ...
            # 3) 작성자
            e = e_ab.find_element_by_xpath('.//dd[3]')
...
################################################################################
def do_start(**kwargs):
    with Gnews02(kwargs['config_f']) as ws:
        ws.start()
        return 0
