"""
====================================
 :mod:`gov/ Gyeongnam_05 : 위해식품 등 긴급회수정보
====================================
...
class Gyeongnam05(PySelenium):
    ...
    def __init__(self, config_f):
        ...
        if not os.path.exists(log_d):
            os.makedirs(log_d)
        logger = get_logger(self.get_safe_path(log_d, 'Gyeongnam05.log'),
        ...
        self.logger.info(f'Starting Gyeongnam05 Crawaling... with '
                         f'config:\n{out_config}')
        ...
        try:
            ...
            for i, ea in enumerate(es):
                ...
                try:
                    ...
                    # 3) 작성자
                    e = ea.find_element_by_xpath('./td[@class="name"]')
...
################################################################################
def do_start(**kwargs):
    with Gyeongnam05(kwargs['config_f']) as ws:
        ws.start()
        return 0
