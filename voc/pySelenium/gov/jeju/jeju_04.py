...
class Jeju04(PySelenium):
    ...
    def __init__(self, config_f):
        ...
        if not os.path.exists(log_d):
            os.makedirs(log_d)
        logger = get_logger(self.get_safe_path(log_d, 'Jeju04.log'),
        ...
        self.logger.info(f'Starting Jeju04 Crawaling... with '
                         f'config:\n{out_config}')
    ...
    def get_article(self, msg, ndx):
        try:
            ...
            # 작성시간
            e = e_ab.find_element_by_xpath('./tbody/tr[2]/td')
...
################################################################################
def do_start(**kwargs):
    with Jeju04(kwargs['config_f']) as ws:
        ws.start()
        return 0
