...
class Mafra02(PySelenium):
    ...
    def __init__(self, config_f):
        ...
        if not os.path.exists(log_d):
            os.makedirs(log_d)
        logger = get_logger(self.get_safe_path(log_d, 'Mafra_02.log'),
        ...
        self.logger.info(f'Starting Mafra_02 Crawaling... with '
                         f'config:\n{out_config}')
...
################################################################################
def do_start(**kwargs):
    with Mafra02(kwargs['config_f']) as ws:
        ws.start()
        return 0
