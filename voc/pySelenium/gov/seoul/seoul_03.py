...
class Seoul03(PySelenium):
    ...
    def __init__(self, config_f):
        ...
        if not os.path.exists(log_d):
            os.makedirs(log_d)
        logger = get_logger(self.get_safe_path(log_d, 'Seoul03.log'),
        ...
        self.logger.info(f'Starting Seoul03 Crawaling... with '
                         f'config:\n{out_config}')
...
################################################################################
def do_start(**kwargs):
    with Seoul03(kwargs['config_f']) as ws:
        ws.start()
        return 0
