...
def crawlingPage(folder_path, login_id, login_pw, announce, announce_date):
    ...
    driver.find_element(By.XPATH, '/html/body/div[3]/div/table/tbody/tr[3]/td[1]').click()    #장학사업
    # driver.find_element(By.XPATH, '/html/body/div[3]/form/table/tbody/tr/th[2]/img').click()   #조회
    # driver.find_element(By.XPATH, '/html/body/div[3]/div/table/tbody/tr[1]/td[1]').click()      #최상단클릭
